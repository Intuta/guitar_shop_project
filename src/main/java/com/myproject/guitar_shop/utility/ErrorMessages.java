...
public class ErrorMessages {
    ...
    public static final String ACCESS_DENIED = "Wrong password or email!";
    public static final String NOT_ENOUGH_PRODUCTS = "Not enough products! Only %s products are available!";
    public static final String PRODUCT_NOT_FOUND = "Not enough products! Only %s products are available!";
}
